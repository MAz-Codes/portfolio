                ...
                <Box textColor={"white"} w="60%" maxW="900px" justify={"center"}>
                      <VStack as={motion.div} transition='.5s ease-out' gap={10} fontSize={{base:"sm", md: "md", lg:"md", xl:"lg"}}>
                        ...
                        <Grid templateColumns="repeat(9, 1fr)" gap={"1vh"}  >
                          <Image src="src/assets/javascript.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}}/>
                          <Image src="src/assets/html.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}} />
                          <Image src="src/assets/css.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}}/>
                          <Image src="src/assets/react.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}}/>
                          <Image src="src/assets/logomark-colored.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}} />
                          <Image src="src/assets/node.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}}/>
                          <Image src="src/assets/vite.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}}/>
                          <Image src="src/assets/figma.svg" minH="2vh" maxH={{base:"4vh", md:"6vh", xl:"7vh"}} />
                          <Image src="src/assets/github.svg" minH="2h" maxH={{base:"4vh", md:"6vh", xl:"7vh"}}/>
                        </Grid>
